...
def figure_settings(fig,label_font_size='25pt',legend_fix=True):
    ...
    fig.xaxis.axis_label_text_font = 'Times New Roman'  # 设置 x 轴标签字体类型为 Times New R
    # oman
    fig.yaxis.axis_label_text_font = 'Times New Roman'  # 设置 y 轴标签字体类型为 Times New Roman
